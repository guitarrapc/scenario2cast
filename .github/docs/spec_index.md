...
| [spec_pty.md](spec_pty.md) | PTY recording — `pty: true`, platform support, capture model, failure behavior, CI |
...
| Implement or debug PTY backend code | [references/pty_crossplatform.md](references/pty_crossplatform.md) |
